...
const NOT_FOR_PHONE = new Map([
  ...
  // Куда класть работу агента (миссии, прогоны и дела): папки выбираются в окне
  // первого запуска на ПК — телефону этот выбор не отдаём.
  ["setup:state", "где лежат файлы работы агента, знает ПК"],
  ["setup:save", "папки работы агента выбираются только с ПК"],
