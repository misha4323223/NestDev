...
contextBridge.exposeInMainWorld("api", {
  ...
  // Удалить миссию вместе с папкой: чистка списка прошлых работ.
  missionDelete: (id) => ipcRenderer.invoke("mission:delete", id || ""),
  ...
  ycSetPermissions: (allowCreate, allowDelete, allowUpdate, allowPublic) => ipcRenderer.invoke("yc:setPermissions", allowCreate, allowDelete, allowUpdate, allowPublic),
  ...
  ycConsoleSecretVersion: (args) => ipcRenderer.invoke("yc:console:secretVersion", args || {}),
  ycConsoleDnsRecord: (args) => ipcRenderer.invoke("yc:console:dnsRecord", args || {}),
