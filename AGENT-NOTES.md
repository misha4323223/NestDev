...
Батчи и журнал миссии (часть 19б): граница батча, призывы сторожа, пауза по «Стоп» —
~200 строк вокруг `mission.afterBatch()`.


### Что осталось в runAi

Строгая очередь с подтверждениями (часть 19): подтверждения человеком, аудит, батчи, журнал миссии —
~320 строк, самое связанное место после разобранного.
