...
Основной цикл раундов (~1100 строк): подготовка запроса, призывы плана и сторожа, авто-миссия,
обработка сбоя с переключением OpenAI-профиля. Дальше по плану — `browser-tools.js`,
